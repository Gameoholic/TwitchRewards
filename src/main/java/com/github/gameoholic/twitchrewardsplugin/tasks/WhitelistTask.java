...
import com.github.gameoholic.twitchrewardsplugin.Rewards.RewardsActivators.Whitelist;
...
public class WhitelistTask extends BukkitRunnable {
    ...
    public WhitelistTask(TwitchRewardsPlugin plugin, String playerUsername, Player affectedPlayer, int time) {
        timeLeft = time + 1;
